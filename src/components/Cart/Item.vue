...
<circle cx="15" cy="15" r="12" fill="#F1DDAA"/>
        ...
        <div class="cart__item-mid-count">
            <div class="counter">
            <svg class="counter__minus" width="10" height="2" viewBox="0 0 10 2" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M10 0.285706H5.71429H4.28571H0V1.71428H4.28571H5.71429H10V0.285706Z" fill="#E0BEA2"/>
            </svg>
            <h4>L</h4>
            <svg class="counter__plus" width="10" height="10" viewBox="0 0 10 10" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<script>
import furcoat from '@/assets/pngs/furcoatSmall.png'
...
.cart__item{
    ...
    &-mid{
        ...
        &__minus{
            cursor: pointer;
            margin: 26px 14px 22px 20px;
        }
        &__plus{
            cursor: pointer;
            margin: 22px 20px 18px 14px;
        }
            h4{
            @include itemStyle;
